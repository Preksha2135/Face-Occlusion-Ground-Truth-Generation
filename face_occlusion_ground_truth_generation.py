...
# Paths
input_folder = "assets/OccludedImages(mini)"  # Folder containing nested folders with images
output_folder = "Your desired folder path/Generated ground truth images"           # Folder to save generated masks
